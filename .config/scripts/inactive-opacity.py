...
IGNORE_APP_IDS = {"spotify", "Spotify", "xed", "marktext", "nemo", "blueman-manager", "org.pulseaudio.pavucontrol", "md.obsidian.Obsidian", "steam"}


def is_ignored(window):
    return window.app_id in IGNORE_APP_IDS or window.window_class in IGNORE_APP_IDS
